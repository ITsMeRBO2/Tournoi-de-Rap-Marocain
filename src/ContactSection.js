...
const ContactSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const backendUrl = process.env.REACT_APP_BACKEND_URL || 'http://localhost:5000/api/contact';
      ...
      if (data.success) {
        ...
        setSubmitStatus({ success: false, message: `Erreur: ${data.message}` });
      }
    } catch (error) {
      ...
      <div className="contact-container">
        ...
        <div className="social-container">
          ...
          <div className="social-links">
            ...
            <a 
              href="https://www.instagram.com/rahil_widadi/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="social-link"
            >
            ...
            <a 
              href="https://github.com/ITsMeRBO2" 
              target="_blank" 
              rel="noopener noreferrer"
              className="social-link"
            >
